...
Интересно, что при beam_width=5 получились наилучшие результаты. При beam_width=10 больше менее вероятных путей конкурируют с лучшими, из-за чего метрики чуть хуже. beam_width=1 (11.24%) почти совпадает с greedy (11.22%), что ожидаемо — beam search с шириной 1 по сути эквивалентен жадному декодированию.
