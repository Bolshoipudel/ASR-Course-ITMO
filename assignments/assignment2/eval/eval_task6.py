...
for alpha in alphas:
    for beta in betas:
        ...
        for _, row in df.iterrows():
            ...
            hyp = decoder.decode(audio, method="beam_lm_rescore")
...
results_df.to_csv("results_rescore_sweep.csv", index=False)
print("Results saved to results_rescore_sweep.csv")
